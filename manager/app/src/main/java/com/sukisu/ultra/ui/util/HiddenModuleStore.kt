...
object HiddenModuleStore {
    ...
    fun getHiddenModuleIds(context: Context): Set<String> = loadSnapshot(context).hiddenModuleIds

    fun shouldHideAllModules(context: Context): Boolean = loadSnapshot(context).shouldHideAllModules

    fun hasPassword(@Suppress("UNUSED_PARAMETER") context: Context): Boolean = fileExists(AUTH_FILE)
    ...
    fun setPassword(@Suppress("UNUSED_PARAMETER") context: Context, password: String) {
        ...
        val payload = JSONObject()
            ...
            .toString()
        writeEncryptedPayload(AUTH_FILE, FilePurpose.Auth, payload)
    }
